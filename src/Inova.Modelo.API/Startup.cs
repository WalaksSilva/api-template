...
using Inova.Modelo.API.Extensions;
using Inova.Modelo.API.Filters;
using Inova.Modelo.API.Middlewares;
using Inova.Modelo.API.Services;
using Inova.Modelo.API.Services.Interfaces;
using Inova.Modelo.API.Settings;
using Inova.Modelo.Domain.Interfaces.Identity;
using Inova.Modelo.Domain.Interfaces.Notifications;
using Inova.Modelo.Domain.Interfaces.Repository;
using Inova.Modelo.Domain.Interfaces.Services;
using Inova.Modelo.Domain.Interfaces.UoW;
using Inova.Modelo.Domain.Notifications;
using Inova.Modelo.Infra.Context;
using Inova.Modelo.Infra.Identity;
using Inova.Modelo.Infra.Repository;
using Inova.Modelo.Infra.Services;
using Inova.Modelo.Infra.UoW;

namespace Inova.Modelo.API;
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        if (!WebHostEnvironment.IsProduction())
        {
            services.AddOpenApiDocument(document =>
            {
                ...
                document.Version = "v1";
                document.Title = "Modelo API";
                document.Description = "API de Modelo";
